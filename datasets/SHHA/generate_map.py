...
if __name__ == "__main__":
    ...
    if dataset == 'SHA':
        ...
        image_dir_path = "/data1/haojie/shanghaitech_org/part_A_final/"+train_test+"_data/images"
        ground_truth_dir_path = "/data1/haojie/shanghaitech_org/part_A_final/"+train_test+"_data/ground_truth"
        output_gt_dir = "/data1/haojie/shanghaitech_org/SH_part_A/"+train_test
    elif dataset == 'SHB':
    ...
    for i in range(num_img):
        ...
        # pd.DataFrame(gt).to_csv(output_gt_dir + "/" + str(i + 1)+".csv", index=False, header=0)
        np.savetxt(output_gt_dir + "/" + str(i + 1)+".csv", gt, delimiter=",")
