...
def loading_data():
    ...
    train_set = PUCPR(cfg_data.DATA_PATH, 'train', main_transform=train_main_transform, img_transform=img_transform, gt_transform=gt_transform, depth_transform=depth_transform)
    train_loader =None
    ...
    val_set = PUCPR(cfg_data.DATA_PATH, 'test', main_transform=None, img_transform=img_transform, gt_transform=gt_transform, depth_transform=depth_transform)
